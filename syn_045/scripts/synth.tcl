...
analyze -format vhdl ../vhdl/mulcascade.vhd
...
create_clock -name CLK -period 5.5 -waveform {0 1.25} {clk}
...
set_input_delay  0.8 -max -clock CLK  [remove_from_collection [all_inputs] [all_clocks] ]
